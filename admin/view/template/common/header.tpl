      ...
      <ul class="nav pull-right">
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-question-circle"></i></a>
          <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="http://www.anzarkhan.com" target="_blank">Anzarkhan.com</a></li>
            <li><a href="http://docs.anzarkhan.com" target="_blank"><?php echo $text_documentation; ?></a></li>
            <li><a href="http://forum.anzarkhan.com" target="_blank"><?php echo $text_forum; ?></a></li>
          </ul>
        </li>
